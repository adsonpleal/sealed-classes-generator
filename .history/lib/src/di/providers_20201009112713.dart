...
SealedClassGenerator provideGenerator() {
  ...
  final generatePositionalConstructorParamsUseCase = GeneratePositionalConstructorParamsUseCase();
  final generateFullPositionalConstructorParamsUseCase =
      GenerateFullPositionalConstructorParamsUseCase(generatePositionalConstructorParamsUseCase);
      final generateNamedConstructorParamsUseCase = GenerateNamedConstructorParamsUseCase();
  final generateFullNamedConstructorParamsUseCase =
      GenerateFullNamedConstructorParamsUseCase(generateNamedConstructorParamsUseCase);
